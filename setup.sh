...
DOCKER_DIR=${ENV_DOCKER_DIR}
DOWNLOADS_DIR=${ENV_DOWNLOADS_DIR}

# VPN (Gluetun)
VPN_SERVICE_PROVIDER=${ENV_VPN_PROVIDER}
VPN_TYPE=${ENV_VPN_TYPE}
WIREGUARD_PRIVATE_KEY=${ENV_WG_KEY}
WIREGUARD_ADDRESSES=${ENV_WG_ADDR}

# API Keys — populated after services start (setup.sh step 10)
SONARR_API_KEY=
RADARR_API_KEY=
PROWLARR_API_KEY=
SEERR_API_KEY=
